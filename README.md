...
On the rig this kit came from (two Kinova Gen3 7-DoF arms on a wearable frame, driven from a simulation through ROS 2 Jazzy under WSL2), the real arms landed **7.2 mm RMS** from where they were told to go on a 100 mm move. Against a 30 mm grasp gate that is a quarter of the budget, and nothing was subtracting it.
...
Every figure above is regenerated by `python3 docs/make_figures.py` from the kit's code and the rig numbers quoted in this file.

Extracted from the MSc project *Multimodal control of a wearable dual-arm robotic system for assisted object manipulation* (Imperial College London, 2026): two Kinova Gen3 arms on a backpack frame, a master mannequin arm and Quest VR as inputs, ROS 2 Jazzy under WSL2. Project repository: <https://github.com/megazron/Multimodal-control-of-a-wearable-dual-arm-robotic-system-for-assisted-object-manipulation>.

Numbers quoted above were measured on that rig on 2026-08-21 and 2026-08-29. Yours will differ; that is what `fit` is for.
